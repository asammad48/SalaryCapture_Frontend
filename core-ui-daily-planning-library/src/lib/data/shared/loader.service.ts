...
export class LoaderService {
  ...
  private readonly loaders = new Map<string, BehaviorSubject<boolean>>();

  private getLoaderSubject(key: string): BehaviorSubject<boolean> {
  ...
  getLoader(key: string): Observable<boolean> {

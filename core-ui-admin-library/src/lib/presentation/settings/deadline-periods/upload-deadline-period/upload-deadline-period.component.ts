...
import { allowedDeadlineFileExtensions } from 'core-ui-admin-library/src/lib/core/domain/constants/application-constants';
import { equalsIgnoreCase } from 'core-ui-admin-library/src/lib/data/shared/helper.function';
...
export class UploadDeadlinePeriodComponent extends AppPortalBase {

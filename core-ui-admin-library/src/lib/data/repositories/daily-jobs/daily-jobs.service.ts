...
import { DailyJobResponse } from "core-ui-admin-library/src/lib/core/domain/models/DailyJobs/daily-jobs-response";
import { DailyJobsFilterRequest } from "core-ui-admin-library/src/lib/core/domain/requests/daily-jobs-filter.request";
import { DailyJobsReportDto } from "core-ui-admin-library/src/lib/core/domain/models/DailyJobs/daily-jobs-grouped-response";
import { PagedRequest } from "core-ui-admin-library/src/lib/core/domain/models/shared/paged-request.model";
import { PagedData } from "core-ui-admin-library/src/lib/core/domain/models/shared/paged-response.model";
import { DailyJobsReportFilterRequest } from "core-ui-admin-library/src/lib/core/domain/requests/daily-jobs-report-filter.request";
